...
export function parseRequest(
  ...
  const preservePendingReplay = () => {
    // Plain unsigned summaries can be dropped at a hard conversation boundary, but signed or
    // redacted reasoning is replay authority and must remain attached to an assistant turn even
    // when no visible assistant text/tool call follows it.
