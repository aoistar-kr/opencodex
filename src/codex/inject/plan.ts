...
export interface CodexInjectionPlanContext {
  ...
  /** Result of the installed-Codex feature registry probe, resolved once per injection. */
  readonly standaloneWebSearchSupported?: boolean;
}
...
export function deriveCodexInjectionPlan(
  ...
  const managesStandaloneWebSearch = ctx.standaloneWebSearchSupported
  ...
  const profileStandaloneWebSearchEnabled = ctx.standaloneWebSearchSupported
